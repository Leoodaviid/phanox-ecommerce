...
export async function POST(req: Request, res: Response) {
  ...
  try {
    ...
    const params: Stripe.Checkout.SessionCreateParams = {
      ...
      success_url: `https://phanox-ecommerce-nine.vercel.app/success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `https://phanox-ecommerce-nine.vercel.app/fail?session_id={CHECKOUT_SESSION_ID}`,
    }
